...
const Body = ()=> {
    const [resList,setresList] = useState(restaurantList); //use restaurantList for initial state 
    ...
    const fetchData=async()=>{
        ...
        //console.log(resData);
        //console.log(resData?.data?.cards[2]?.card?.card?.gridElements?.infoWithStyle?.restaurants[0]?.info.name);
